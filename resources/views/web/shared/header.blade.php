			...
			<div class="form-group with-button">
				...
				<button>
					<svg class="olymp-magnifying-glass-icon">
						<use xlink:href="{{ asset('web/icons/icons.svg#olymp-magnifying-glass-icon') }}"></use>
					</svg>
				</button>
			</div>
		</form>
		...
		<div class="control-block">
						...
						<ul class="notification-list friend-requests">
							<li>
								<div class="author-thumb">
									<img src="{{ asset('web/img/avatar55-sm.jpg') }}" alt="author">
								</div>
							...
							<li>
								<div class="author-thumb">
									<img src="{{ asset('web/img/avatar56-sm.jpg') }}" alt="author">
								</div>
								<div class="notification-event">
							...
							<li class="accepted">
								<div class="author-thumb">
									<img src="{{ asset('web/img/avatar57-sm.jpg') }}" alt="author">
								</div>
								<div class="notification-event">
									You and
								...
								<div class="more">
									...
									<svg class="olymp-little-delete">
										<use xlink:href="{{ asset('web/icons/icons.svg#olymp-little-delete') }}"></use>
									</svg>
								</div>
							</li>
							...
							<li>
								<div class="author-thumb">
									<img src="{{ asset('web/img/avatar58-sm.jpg') }}" alt="author">
								</div>
								<div class="notification-event">
			...
			<div class="control-icon more has-items">
				<svg class="olymp-chat---messages-icon">
					<use xlink:href="{{ asset('web/icons/icons.svg#olymp-chat---messages-icon') }}"></use>
				</svg>
					...
					<div class="mCustomScrollbar" data-mcs-theme="dark">
						<ul class="notification-list chat-message">
							<li class="message-unread">
								<div class="author-thumb">
									<img src="{{ asset('web/img/avatar59-sm.jpg') }}" alt="author">
								</div>
								<div class="notification-event">
							...
							<li>
								<div class="author-thumb">
									<img src="{{ asset('web/img/avatar60-sm.jpg') }}" alt="author">
								</div>
								<div class="notification-event">
							...
							<li>
								<div class="author-thumb">
									<img src="{{ asset('web/img/avatar61-sm.jpg') }}" alt="author">
								</div>
								<div class="notification-event">
							...
							<li class="chat-group">
								<div class="author-thumb">
									<img src="{{ asset('web/img/avatar11-sm.jpg') }}" alt="author">
									<img src="{{ asset('web/img/avatar12-sm.jpg') }}" alt="author">
									<img src="{{ asset('web/img/avatar13-sm.jpg') }}" alt="author">
			...
			<div class="control-icon more has-items">
				<svg class="olymp-thunder-icon">
					<use xlink:href="{{ asset('web/icons/icons.svg#olymp-thunder-icon')}}"></use>
				</svg>
				...
				<div class="more-dropdown more-with-triangle triangle-top-center">
					...
					<div class="mCustomScrollbar" data-mcs-theme="dark">
						<ul class="notification-list">
							<li>
								<div class="author-thumb">
									<img src="{{ asset('web/img/avatar62-sm.jpg') }}" alt="author">
								</div>
								<div class="notification-event">
									<div>
							...
							<li class="un-read">
								<div class="author-thumb">
									<img src="{{ asset('web/img/avatar63-sm.jpg') }}" alt="author">
								</div>
								<div class="notification-event">
									<div>You and
							...
							<li class="with-comment-photo">
								<div class="author-thumb">
									<img src="{{ asset('web/img/avatar64-sm.jpg') }}" alt="author">
								</div>
								<div class="notification-event">
									<div>
								...
								<div class="comment-photo">
									<img src="{{ asset('web/img/comment-photo1.jpg') }}" alt="photo">
							...
							<li>
								<div class="author-thumb">
									<img src="{{ asset('web/img/avatar65-sm.jpg') }}" alt="author">
								</div>
								<div class="notification-event">
									<div>
							...
							<li>
								<div class="author-thumb">
									<img src="{{ asset('web/img/avatar66-sm.jpg') }}" alt="author">
								</div>
								<div class="notification-event">
									<div>
			...
			<div class="author-page author vcard inline-items more">
				<div class="author-thumb">
					<img alt="author" style="width:36px;height:36px;" src="{{ $user->image }}" class="avatar">
							...
							<form class="form-group with-button custom-status">
								...
								<button class="bg-purple">
									<svg class="olymp-check-icon">
										<use xlink:href="{{ asset('web/icons/icons.svg#olymp-check-icon') }}"></use>
									</svg>
								</button>
							</form>
				...
				<a href="" class="author-name fn">
					<div class="author-title">
						...
						<svg class="olymp-dropdown-arrow-icon">
							<use xlink:href="{{ asset('web/icons/icons.svg#olymp-dropdown-arrow-icon') }}"></use>
						</svg>
					</div>
				</a>
			</div>
